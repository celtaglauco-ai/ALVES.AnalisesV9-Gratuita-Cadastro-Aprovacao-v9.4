...
export async function GET(req:Request){
 ...
 const head="Date,Round,HomeTeam,AwayTeam,FTHG,FTAG,Referee,Source",body=games.map((g:any)=>[g.date,g.round,g.home,g.away,g.hg,g.ag,g.referee,"API-Football"].map(esc).join(","));
